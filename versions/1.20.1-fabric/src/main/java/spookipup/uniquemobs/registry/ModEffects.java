...
public class ModEffects {
	...
	public static final MobEffect SOUL_SCORCH = Registry.register(
		BuiltInRegistries.MOB_EFFECT,
		new ResourceLocation(UniqueMobs.MOD_ID, "soul_scorch"),
		new SoulScorchMobEffect()
	);

	public static final MobEffect BLIGHT = Registry.register(
		BuiltInRegistries.MOB_EFFECT,
		new ResourceLocation(UniqueMobs.MOD_ID, "blight"),
		new BlightMobEffect()
	);

	public static final MobEffect BRAND_MARK = Registry.register(
		BuiltInRegistries.MOB_EFFECT,
		new ResourceLocation(UniqueMobs.MOD_ID, "brand_mark"),
		new BrandMarkMobEffect()
	);

	public static final MobEffect PETAL_MARK = Registry.register(
		BuiltInRegistries.MOB_EFFECT,
		new ResourceLocation(UniqueMobs.MOD_ID, "petal_mark"),
		new PetalMarkMobEffect()
	);

	public static final MobEffect BLOSSOM_DRIFT = Registry.register(
		BuiltInRegistries.MOB_EFFECT,
		new ResourceLocation(UniqueMobs.MOD_ID, "blossom_drift"),
