...
public class ModEntities {
	...
	public static final EntityType<BlossomZombieEntity> BLOSSOM_ZOMBIE = Registry.register(
		BuiltInRegistries.ENTITY_TYPE,
		id("blossom_zombie"),
		EntityType.Builder.of(BlossomZombieEntity::new, MobCategory.MONSTER)
			.sized(0.6F, 1.95F).clientTrackingRange(8)
			.build("blossom_zombie")
	);
	...
	public static final EntityType<BlossomSkeletonEntity> BLOSSOM_SKELETON = Registry.register(
		BuiltInRegistries.ENTITY_TYPE,
		id("blossom_skeleton"),
		EntityType.Builder.of(BlossomSkeletonEntity::new, MobCategory.MONSTER)
			.sized(0.6F, 1.99F).clientTrackingRange(8)
			.build("blossom_skeleton")
	);
	...
	public static final EntityType<BlossomCreeperEntity> BLOSSOM_CREEPER = Registry.register(
		BuiltInRegistries.ENTITY_TYPE,
		id("blossom_creeper"),
		EntityType.Builder.of(BlossomCreeperEntity::new, MobCategory.MONSTER)
			.sized(0.6F, 1.7F).clientTrackingRange(8)
			.build("blossom_creeper")
	);
	...
	public static final EntityType<BlossomEndermanEntity> BLOSSOM_ENDERMAN = Registry.register(
		BuiltInRegistries.ENTITY_TYPE,
		id("blossom_enderman"),
		EntityType.Builder.of(BlossomEndermanEntity::new, MobCategory.MONSTER)
			.sized(0.6F, 2.9F).clientTrackingRange(8)
			.build("blossom_enderman")
	);

	public static final EntityType<BlossomEndermanAfterimageEntity> BLOSSOM_ENDERMAN_AFTERIMAGE = Registry.register(
		BuiltInRegistries.ENTITY_TYPE,
		id("blossom_enderman_afterimage"),
		EntityType.Builder.of(BlossomEndermanAfterimageEntity::new, MobCategory.MISC)
			.sized(0.6F, 2.9F).clientTrackingRange(8).updateInterval(2)
			.build("blossom_enderman_afterimage")
	);
	...
	public static final EntityType<WitherAshBoltEntity> WITHER_ASH_BOLT = Registry.register(
		...
		EntityType.Builder.<WitherAshBoltEntity>of(WitherAshBoltEntity::new, MobCategory.MISC)
			...
			.build("wither_ash_bolt")
	);

	public static final EntityType<BlossomArrowEntity> BLOSSOM_ARROW = Registry.register(
		BuiltInRegistries.ENTITY_TYPE,
		id("blossom_arrow"),
		EntityType.Builder.<BlossomArrowEntity>of(BlossomArrowEntity::new, MobCategory.MISC)
	...
	public static final EntityType<SoulFireTrailCloud> SOUL_FIRE_TRAIL_CLOUD = Registry.register(
		...
		EntityType.Builder.<SoulFireTrailCloud>of(SoulFireTrailCloud::new, MobCategory.MISC)
			...
			.build("soul_fire_trail_cloud")
	);

	private static ResourceLocation id(String name) {
		return ResourceLocation.fromNamespaceAndPath(UniqueMobs.MOD_ID, name);
	}
	...
	private static void registerAttributes() {
		...
		FabricDefaultAttributeRegistry.register(BLOSSOM_ZOMBIE, BlossomZombieEntity.createAttributes());
		...
		FabricDefaultAttributeRegistry.register(BLOSSOM_SKELETON, BlossomSkeletonEntity.createAttributes());
		...
		FabricDefaultAttributeRegistry.register(BLOSSOM_CREEPER, BlossomCreeperEntity.createAttributes());
		...
		FabricDefaultAttributeRegistry.register(BLOSSOM_ENDERMAN, BlossomEndermanEntity.createAttributes());
		FabricDefaultAttributeRegistry.register(BLOSSOM_ENDERMAN_AFTERIMAGE, BlossomEndermanAfterimageEntity.createAttributes());
