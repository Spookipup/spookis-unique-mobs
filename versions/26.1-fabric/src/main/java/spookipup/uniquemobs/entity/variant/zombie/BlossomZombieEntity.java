	...
	public boolean doHurtTarget(ServerLevel level, Entity target) {
		...
		if (hit && target instanceof LivingEntity living) {
			if (living.hasEffect(ModEffects.BLOSSOM_DRIFT)) {
				...
				living.addEffect(new MobEffectInstance(MobEffects.SLOWNESS, 25, 3), this);
				BlossomHelper.spawnPetalBurst(level, living.getX(), living.getY(0.2), living.getZ(), 1.0, 22);
