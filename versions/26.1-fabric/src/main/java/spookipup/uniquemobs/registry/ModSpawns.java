...
public class ModSpawns {
	...
	private static void registerPlacements() {
		...
		monsterPlacement(ModEntities.BLOSSOM_ZOMBIE);
		...
		monsterPlacement(ModEntities.BLOSSOM_SKELETON);
	...
	private static void registerBiomeSpawns() {
		...
		spawn("wither_zombie",    cfg, ModEntities.WITHER_ZOMBIE,    12, 1, 1, ModSpawns::overworld);
		spawn("wither_zombie",    cfg, ModEntities.WITHER_ZOMBIE,     8, 1, 1, ModSpawns::nether);
		...
		spawn("blossom_zombie",   cfg, ModEntities.BLOSSOM_ZOMBIE,   90, 1, 2, ModSpawns::cherry);
		spawn("blossom_zombie",   cfg, ModEntities.BLOSSOM_ZOMBIE,   20, 1, 1, ModSpawns::forest);
		...
		spawn("wither_spider",       cfg, ModEntities.WITHER_SPIDER,       20, 1, 1, ModSpawns::overworld);
		spawn("wither_spider",       cfg, ModEntities.WITHER_SPIDER,        8, 1, 1, ModSpawns::nether);
		...
		spawn("blossom_skeleton",    cfg, ModEntities.BLOSSOM_SKELETON,    70, 1, 1, ModSpawns::cherry);
		spawn("blossom_skeleton",    cfg, ModEntities.BLOSSOM_SKELETON,    18, 1, 1, ModSpawns::forest);
		...
		spawn("wither_creeper",      cfg, ModEntities.WITHER_CREEPER,      18, 1, 1, ModSpawns::overworld);
		spawn("wither_creeper",      cfg, ModEntities.WITHER_CREEPER,       7, 1, 1, ModSpawns::nether);
		...
		spawn("blossom_creeper",     cfg, ModEntities.BLOSSOM_CREEPER,     55, 1, 1, ModSpawns::cherry);
		spawn("blossom_creeper",     cfg, ModEntities.BLOSSOM_CREEPER,     12, 1, 1, ModSpawns::forest);
		...
		spawn("blossom_enderman",    cfg, ModEntities.BLOSSOM_ENDERMAN,    14, 1, 1, ModSpawns::cherry);
	...
	private static void cherry(EntityType<?> type, int weight, int min, int max) {
		BiomeModifications.addSpawn(
