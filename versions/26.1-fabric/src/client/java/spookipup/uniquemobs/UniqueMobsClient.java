...
public class UniqueMobsClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		EntityRenderers.register(ModEntities.BLOSSOM_ZOMBIE,
		...
		EntityRenderers.register(ModEntities.BLOSSOM_CREEPER,
		...
		EntityRenderers.register(ModEntities.BLOSSOM_SKELETON,
		...
		EntityRenderers.register(ModEntities.BLOSSOM_ENDERMAN,
			ctx -> new RetexturedEndermanRenderer(ctx, endermanTex("blossom_enderman"), endermanTex("blossom_enderman_eyes")));
		EntityRenderers.register(ModEntities.BLOSSOM_ENDERMAN_AFTERIMAGE,
			ctx -> new RetexturedEndermanRenderer(ctx, endermanTex("blossom_enderman"), endermanTex("blossom_enderman_eyes")));
		...
		EntityRenderers.register(ModEntities.SKITTERLING,
			ctx -> new RetexturedGhastRenderer(ctx, ghastTex("skitterling"), ghastTex("skitterling_charging"),
				null, ghastTex("skitterling_charging_glow")));
		...
		EntityRenderers.register(ModEntities.BLOSSOM_ARROW, TippableArrowRenderer::new);
