...
public class BlightSporeEntity extends ThrowableProjectile implements ItemSupplier {
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		builder.define(DATA_IS_HOVERING, false);
	}
	...
	protected double getDefaultGravity() {
		return this.isHovering() ? 0.0 : 0.0;
	}
	...
	private void checkContactBurst() {
		...
		LivingEntity hit = contacts.getFirst();
	...
	private void applyDirectHit(ServerLevel serverLevel, LivingEntity livingTarget) {
		...
		livingTarget.hurtServer(serverLevel, this.damageSources().mobProjectile(this, owner), DIRECT_HIT_DAMAGE);
